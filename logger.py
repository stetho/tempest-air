...
def read_sensor(pms: PMS5003) -> dict | None:
    ...
    try:
        ...
        return {
            ...
            "pm1_0_atmos": data.pm_ug_per_m3(1.0, atmospheric_environment=True),
            "pm2_5_atmos": data.pm_ug_per_m3(2.5, atmospheric_environment=True),
            "pm10_atmos":  data.pm_ug_per_m3(10,  atmospheric_environment=True),
